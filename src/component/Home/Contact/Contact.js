...
const Contact = () => {
    return (
        <div className="w-full mt-7">
            ...
            {/* icon  */}
            <div className='grid sm:grid-cols-1 md:grid-cols-2 mt-6 sm:mx-auto'>
                <div>
                ...
                <div className='pt-5 custom-form'>
                    <form action="">
                           <input type="text" placeholder="Your name" className="input input-bordered text-black  w-96" /> <br />
                        <input type="email" placeholder="Your Email" className="input input-bordered text-black my-5 w-96"/> <br />
                        <input type="phone" placeholder="Phone" className="input input-bordered text-black w-96 mb-5" /><br />
