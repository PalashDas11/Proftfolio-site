...
const Hero = () => {
    return (
        <div className="px-5 lg:flex items-center ">
            ...
            <div className='w-full custom-hero-content col-span-2 pl-20'>
                <h3 className="pt-4 text-primary text-md">Hi There, I'm</h3>
                <h2 className="text-6xl name font-bold pt-5 ">Palash Das.</h2>
